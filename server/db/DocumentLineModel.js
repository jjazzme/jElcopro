...
export default class DocumentLine extends BaseModel {
    ...
    static registerHooks() {
        ...
        this.beforeSave(async (line) => {
            ...
            } else if (changes && changes.includes('price_without_vat')) {
                line.amount_without_vat = line.price_without_vat * line.quantity;
                line.price_with_vat = line.price_without_vat * (1 + (line.vat / 100));
                line.amount_with_vat = line.price_with_vat * line.quantity;
            } else if (changes && changes.includes('price_with_vat')) {
                line.price_without_vat = line.price_with_vat / (1 + (line.vat / 100));
                line.amount_without_vat = line.price_without_vat * line.quantity;
                line.amount_with_vat = line.price_with_vat * line.quantity;
            } else if (changes && changes.includes('amount_without_vat')) {
                line.price_without_vat = line.amount_without_vat / line.quantity;
                line.price_with_vat = line.price_without_vat * (1 + (line.vat / 100));
                line.amount_with_vat = line.price_with_vat * line.quantity;
            } else if (changes && changes.includes('amount_with_vat')) {
                line.price_with_vat = line.amount_with_vat / line.quantity;
                line.price_without_vat = line.price_with_vat / (1 + (line.vat / 100));
                line.amount_without_vat = line.price_without_vat * line.quantity;
            }
        });
