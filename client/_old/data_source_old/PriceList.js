...
export default class PriceList{
  ...
  constructor({
    ...
    this.card = {
      ...
      producer: {alias: 'произв.', field:'producer_name', to: item=> {return {name:'producer', params:{id:item.producer_id}}} },
  ...
  isSourceActual(optics){
    if (this.sourceCreated + this.classSourceActualTTL < Date.now()) return false;
    let isActual = true;
    _.forEach(optics, (val, key) => {
      if (this[key] !== val) isActual = false;
    });
    return isActual;
  }
